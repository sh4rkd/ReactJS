        ...
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                <Link to="/" className="flex">
                    <img className="mr-3 h-10" src="//d1glcu56fxkf6q.cloudfront.net/statics/2022-02-24/images/LostArkLogo.png" alt="Logotipo de Lost Ark"/>
                </Link>
                ...
                <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
                    <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        <li>
                            <Link to="/" className="block py-2 pr-4 pl-3 text-white bg-yellow-300 rounded md:bg-transparent md:text-yellow-300 md:p-0 dark:text-white" aria-current="page">Home</Link>
                        </li>
                        <li>
                        ...
                        <li class="font-sans block mt-4 lg:inline-block lg:mt-0 lg:ml-6 align-middle text-white hover:text-yellow-300">
                            <Link to="/cart">
                                <CartWidget />
                            </Link>
                        </li>                        
